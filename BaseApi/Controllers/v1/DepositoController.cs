...
namespace Base.API.Controllers.v1
{
    ...
    public class DepositoController : ControllerBase
    {
        ...
        [HttpGet("{id:int}")]
        public async Task<IActionResult> GetById(int id, [FromServices] IDepositoService service)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] DepositoCadastrarCommand menuCommand, [FromServices] DepositoHandler handler)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<IActionResult> Put([FromBody] DepositoAtualizarCommand menuCommand, [FromServices] DepositoHandler handler)
        {
            try
            {
                var retorno = (Retorno)await handler.Handle(menuCommand);
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> Delete(int id, [FromServices] IDeposito repository)
        {
            try
            {
