...
namespace Base.API.Controllers.v1
{
    ...
    public class SaqueController : ControllerBase
    {
        ...
        [HttpGet("{id:int}")]
        public async Task<IActionResult> GetById(int id, [FromServices] ISaquesService service)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] SaqueCadastrarCommand menuCommand, [FromServices] SaqueHandler handler)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<IActionResult> Put([FromBody] SaqueAtualizarCommand menuCommand, [FromServices] SaqueHandler handler)
        {
            try
            {
                var retorno = (Retorno)await handler.Handle(menuCommand);
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> Delete(int id, [FromServices] ISaque repository)
        {
            try
            {
